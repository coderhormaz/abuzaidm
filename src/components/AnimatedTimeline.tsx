...
const timelineData: TimelineItem[] = [
  {
    ...
    description: 'Began my journey in the world of programming and web development.',
    side: 'left',
  },
  {
    id: 2,
    year: '2019',
    title: 'First Project',
    description: 'Completed my first major project using React and modern web technologies.',
    side: 'right',
  },
  {
    id: 3,
    ...
    description: 'Deepened my knowledge in advanced frontend and backend technologies.',
    side: 'left',
  },
  {
    id: 4,
    ...
    description: 'Started working professionally as a full-stack developer on enterprise applications.',
    side: 'right',
  },
  {
    id: 5,
    ...
    description: 'Took on a leadership role managing a team of developers on a major project.',
    side: 'left',
  },
  {
    id: 6,
    ...
    description: 'Received recognition for innovative solutions in web application development.',
    side: 'right',
  },
];
